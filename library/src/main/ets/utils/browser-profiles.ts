 ...
 */
const getBrowserSubtitleProfiles = (videoElement: any, options?: DeviceProfileGeneratorOptions): SubtitleProfile[] => {
 ...
 */
export const getBrowserDeviceProfile = (options?: DeviceProfileGeneratorOptions, videoElement?: any): DeviceProfile => {
